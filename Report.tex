...
observe how the pollutant particles diffuse.
    ...
    \caption{Scatter plot of pollutant dispersion without source term.}
    \end{figure}
...
\emph{compute\_concentration} using a surface contour plot.
    ...
    \caption{Concentration field of pollutant dispersion without source term.}
    \end{figure}
...
Similarly, the concentration field can be plotted with the source term.
    ...
    \caption{Scatter plot of pollutant dispersion with source term.}
    \end{figure}

    \begin{figure}[H]
    \centering
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{Report_files/Report_17_0.png}
    \caption{Concentration field of pollutant dispersion with source term.}
    \end{figure}
...
of pollutants. The diffusion coefficient D represents molecular
agitation and random motion, a value of zero results in no spreading,
while increasing D causes the particle cloud to expand more rapidly,
leading to lower concentrations. The velocity field u represents
deterministic transport by fluid flow, determining the cloud's center of
mass trajectory without affecting its expansion rate. Finally, the
emission rate Q defines the pollutant source strength, where a non-zero
Q in Task 3 represents a continuous source like an exhaust pipe,
creating a steady-state output with peak concentrations at the source
location.

This project highlights the complementarity between the macroscopic
Eulerian viewpoint (PDE) and the microscopic Lagrangian viewpoint (SDE).
The advection-diffusion equation provides a mathematically rigorous,
smooth representation of density but can be computationally demanding.
In contrast, the stochastic approach uses Itô differential equations to
simulate individual particle trajectories, which is often easier to
implement for complex scenarios like continuous injection without
requiring a mesh. However, a key challenge in this method is the choice
of the smoothing parameter ϵ, a value too small makes the field appear
noisy, while one too large artificially flattens concentration peaks.

The simulation results across different tasks demonstrate how advection
and diffusion jointly determine the pollutant's shape. While advection
pushes the cloud along the x-axis, diffusion causes it to expand in all
directions, decreasing peak concentration over time. The most striking
difference appears between the instantaneous release in Tasks 1 and 2
and the continuous release in Task 3. In the former, the cloud remains
roughly circular as it expands and drifts. In the latter, the constant
injection of particles fills the space between the source and the
leading edge, forming a characteristic cone-shaped plume typically seen
...
\begin{Verbatim}[commandchars=\\\{\}]
\PY{c+c1}{\PYZsh{} Implementation of the Euler\PYZhy{}Maruyama method for simulating particle trajectories}
...
\PY{+w}{    }\PY{l+s+sd}{\PYZsq{}\PYZsq{}\PYZsq{}N number of particles, T total time, h time step, D diffusion coefficient, u velocity vector, num\PYZus{}steps number of steps, checkpoints list of time checkpoints to save snapshots, q particle injection rate\PYZsq{}\PYZsq{}\PYZsq{}}
    ...
    \PY{n}{snapshots} \PY{o}{=} \PY{p}{[}\PY{p}{]} \PY{c+c1}{\PYZsh{} To store particle positions at different time checkpoints}

    \PY{k}{for} \PY{n}{n} \PY{o+ow}{in} \PY{n+nb}{range}\PY{p}{(}\PY{n}{num\PYZus{}steps} \PY{o}{+} \PY{l+m+mi}{1}\PY{p}{)}\PY{p}{:} \PY{c+c1}{\PYZsh{} Loop over time steps}
        \PY{n}{new\PYZus{}particles} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{zeros}\PY{p}{(}\PY{p}{(}\PY{n}{particles\PYZus{}per\PYZus{}step}\PY{p}{,} \PY{l+m+mi}{2}\PY{p}{)}\PY{p}{)} \PY{c+c1}{\PYZsh{} New particles are injected at the origin (0, 0)}
        \PY{n}{X} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{vstack}\PY{p}{(}\PY{p}{[}\PY{n}{X}\PY{p}{,} \PY{n}{new\PYZus{}particles}\PY{p}{]}\PY{p}{)}
        
        \PY{n}{num\PYZus{}active} \PY{o}{=} \PY{n}{X}\PY{o}{.}\PY{n}{shape}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{]} \PY{c+c1}{\PYZsh{} Update positions of all active particles using the Euler\PYZhy{}Maruyama method}
    ...
    \PY{k}{return} \PY{n}{snapshots} \PY{c+c1}{\PYZsh{} Return the snapshots of particle positions at specified checkpoints}
\end{Verbatim}
\end{tcolorbox}
...
\PY{n}{N} \PY{o}{=} \PY{l+m+mi}{2000}        \PY{c+c1}{\PYZsh{} Initial number of particles}
\PY{n}{T} \PY{o}{=} \PY{l+m+mi}{60}          \PY{c+c1}{\PYZsh{} Total simulation time}
\PY{n}{h} \PY{o}{=} \PY{l+m+mf}{0.1}         \PY{c+c1}{\PYZsh{} Time step}
\PY{n}{D} \PY{o}{=} \PY{l+m+mf}{0.02}        \PY{c+c1}{\PYZsh{} Diffusion coefficient}
\PY{n}{epsilon} \PY{o}{=} \PY{l+m+mf}{0.1}   \PY{c+c1}{\PYZsh{} Epsilon}

\PY{n}{u} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{array}\PY{p}{(}\PY{p}{[}\PY{l+m+mf}{0.3}\PY{p}{,} \PY{l+m+mi}{0}\PY{p}{]}\PY{p}{)}      \PY{c+c1}{\PYZsh{} Velocity vector (drift in the x\PYZhy{}direction)}
\PY{n}{num\PYZus{}steps} \PY{o}{=} \PY{n+nb}{int}\PY{p}{(}\PY{n}{T} \PY{o}{/} \PY{n}{h}\PY{p}{)}
\PY{n}{checkpoints} \PY{o}{=} \PY{p}{[}\PY{l+m+mi}{15}\PY{p}{,} \PY{l+m+mi}{30}\PY{p}{,} \PY{l+m+mi}{45}\PY{p}{,} \PY{l+m+mi}{60}\PY{p}{]} \PY{c+c1}{\PYZsh{} Time checkpoints to save snapshots}
\end{Verbatim}
\end{tcolorbox}
...
\begin{Verbatim}[commandchars=\\\{\}]
\PY{c+c1}{\PYZsh{} Plotting the results without a source term (q=0)}
\PY{n}{snapshots} \PY{o}{=} \PY{n}{euler}\PY{p}{(}\PY{n}{N}\PY{p}{,}\PY{n}{T}\PY{p}{,}\PY{n}{h}\PY{p}{,}\PY{n}{D}\PY{p}{,}\PY{n}{u}\PY{p}{,}\PY{n}{num\PYZus{}steps}\PY{p}{,} \PY{n}{checkpoints}\PY{p}{,} \PY{l+m+mi}{0}\PY{p}{)} \PY{c+c1}{\PYZsh{} Calling the Euler\PYZhy{}Maruyama function with the above parameters.}
...
\PY{k}{for} \PY{n}{i}\PY{p}{,} \PY{n}{t} \PY{o+ow}{in} \PY{n+nb}{enumerate}\PY{p}{(}\PY{n}{checkpoints}\PY{p}{)}\PY{p}{:}
    ...
    \PY{n}{axes}\PY{p}{[}\PY{n}{i}\PY{p}{]}\PY{o}{.}\PY{n}{set\PYZus{}title}\PY{p}{(}\PY{l+s+sa}{f}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Time: }\PY{l+s+si}{\PYZob{}}\PY{n}{t}\PY{l+s+si}{\PYZcb{}}\PY{l+s+s2}{s}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}
    ...
    \PY{n}{axes}\PY{p}{[}\PY{n}{i}\PY{p}{]}\PY{o}{.}\PY{n}{set\PYZus{}xlabel}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{x [Position]}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}
    \PY{n}{axes}\PY{p}{[}\PY{n}{i}\PY{p}{]}\PY{o}{.}\PY{n}{set\PYZus{}ylabel}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{y [Position]}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}
...
\begin{Verbatim}[commandchars=\\\{\}]
\PY{k}{def}\PY{+w}{ }\PY{n+nf}{delta\PYZus{}eps}\PY{p}{(}\PY{n}{dist}\PY{p}{,} \PY{n}{epsilon}\PY{p}{)}\PY{p}{:} \PY{c+c1}{\PYZsh{} Gaussian kernel function to approximate the delta function}
...
\PY{k}{def}\PY{+w}{ }\PY{n+nf}{compute\PYZus{}concentration}\PY{p}{(}\PY{n}{x\PYZus{}grid}\PY{p}{,} \PY{n}{y\PYZus{}grid}\PY{p}{,} \PY{n}{snapshot}\PY{p}{,} \PY{n}{epsilon}\PY{p}{)}\PY{p}{:} \PY{c+c1}{\PYZsh{} Compute the concentration field from particle positions using the Gaussian kernel}
    ...
    \PY{k}{for} \PY{n}{k} \PY{o+ow}{in} \PY{n+nb}{range}\PY{p}{(}\PY{n}{N}\PY{p}{)}\PY{p}{:} \PY{c+c1}{\PYZsh{} Loop over all particles and add their contribution to the concentration field using the Gaussian kernel}
...
\begin{Verbatim}[commandchars=\\\{\}]
\PY{c+c1}{\PYZsh{} Setup grid for concentration field}
...
\PY{k}{for} \PY{n}{i} \PY{o+ow}{in} \PY{n+nb}{range}\PY{p}{(}\PY{n+nb}{len}\PY{p}{(}\PY{n}{snapshots}\PY{p}{)}\PY{p}{)}\PY{p}{:} \PY{c+c1}{\PYZsh{} Compute and plot the concentration field for each snapshot.}
    ...
    \PY{n}{contour} \PY{o}{=} \PY{n}{axes}\PY{p}{[}\PY{n}{i}\PY{p}{]}\PY{o}{.}\PY{n}{contourf}\PY{p}{(}\PY{n}{x\PYZus{}grid}\PY{p}{,} \PY{n}{y\PYZus{}grid}\PY{p}{,} \PY{n}{C}\PY{p}{,} \PY{n}{levels}\PY{o}{=}\PY{l+m+mi}{15}\PY{p}{,} \PY{n}{cmap}\PY{o}{=}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Reds}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
    \PY{n}{axes}\PY{p}{[}\PY{n}{i}\PY{p}{]}\PY{o}{.}\PY{n}{set\PYZus{}title}\PY{p}{(}\PY{l+s+sa}{f}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Time: }\PY{l+s+si}{\PYZob{}}\PY{n}{checkpoints}\PY{p}{[}\PY{n}{i}\PY{p}{]}\PY{l+s+si}{\PYZcb{}}\PY{l+s+s2}{ s}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}
    \PY{n}{axes}\PY{p}{[}\PY{n}{i}\PY{p}{]}\PY{o}{.}\PY{n}{set\PYZus{}xlim}\PY{p}{(}\PY{l+m+mi}{0}\PY{p}{,} \PY{l+m+mi}{25}\PY{p}{)}
    \PY{n}{axes}\PY{p}{[}\PY{n}{i}\PY{p}{]}\PY{o}{.}\PY{n}{set\PYZus{}ylim}\PY{p}{(}\PY{o}{\PYZhy{}}\PY{l+m+mi}{5}\PY{p}{,} \PY{l+m+mi}{5}\PY{p}{)}  
    \PY{n}{axes}\PY{p}{[}\PY{n}{i}\PY{p}{]}\PY{o}{.}\PY{n}{set\PYZus{}xlabel}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{x [Position]}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}
    \PY{n}{axes}\PY{p}{[}\PY{n}{i}\PY{p}{]}\PY{o}{.}\PY{n}{set\PYZus{}ylabel}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{y [Position]}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}
...
\PY{n}{fig}\PY{o}{.}\PY{n}{subplots\PYZus{}adjust}\PY{p}{(}\PY{n}{bottom}\PY{o}{=}\PY{l+m+mf}{0.18}\PY{p}{)}
...
\begin{Verbatim}[commandchars=\\\{\}]
\PY{c+c1}{\PYZsh{} Constants for the simulation with a source term (q=100)}
\PY{n}{N} \PY{o}{=} \PY{l+m+mi}{0}         \PY{c+c1}{\PYZsh{} Initial number of particles (starts at 0 since we have a source term)}
\PY{n}{T} \PY{o}{=} \PY{l+m+mi}{60}        \PY{c+c1}{\PYZsh{} Total simulation time}
\PY{n}{h} \PY{o}{=} \PY{l+m+mf}{0.1}       \PY{c+c1}{\PYZsh{} Time step}
\PY{n}{D} \PY{o}{=} \PY{l+m+mf}{0.02}      \PY{c+c1}{\PYZsh{} Diffusion coefficient}
\PY{n}{Q} \PY{o}{=} \PY{l+m+mi}{100}       \PY{c+c1}{\PYZsh{} Source term}
\PY{n}{u} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{array}\PY{p}{(}\PY{p}{[}\PY{l+m+mf}{0.3}\PY{p}{,} \PY{l+m+mi}{0}\PY{p}{]}\PY{p}{)}  \PY{c+c1}{\PYZsh{} Velocity vector}
\PY{n}{num\PYZus{}steps} \PY{o}{=} \PY{n+nb}{int}\PY{p}{(}\PY{n}{T} \PY{o}{/} \PY{n}{h}\PY{p}{)}
\PY{n}{checkpoints} \PY{o}{=} \PY{p}{[}\PY{l+m+mi}{15}\PY{p}{,} \PY{l+m+mi}{30}\PY{p}{,} \PY{l+m+mi}{45}\PY{p}{,} \PY{l+m+mi}{60}\PY{p}{]} \PY{c+c1}{\PYZsh{} Time checkpoints to save snapshots}
\end{Verbatim}
\end{tcolorbox}
...
\begin{Verbatim}[commandchars=\\\{\}]
\PY{n}{snapshots} \PY{o}{=} \PY{n}{euler}\PY{p}{(}\PY{n}{N}\PY{p}{,}\PY{n}{T}\PY{p}{,}\PY{n}{h}\PY{p}{,}\PY{n}{D}\PY{p}{,}\PY{n}{u}\PY{p}{,}\PY{n}{num\PYZus{}steps}\PY{p}{,} \PY{n}{checkpoints}\PY{p}{,}\PY{n}{Q}\PY{p}{)} \PY{c+c1}{\PYZsh{} Calling the Euler\PYZhy{}Maruyama function with the above parameters, including the source term (q=100).}

\PY{n}{fig}\PY{p}{,} \PY{n}{axes} \PY{o}{=} \PY{n}{plt}\PY{o}{.}\PY{n}{subplots}\PY{p}{(}\PY{l+m+mi}{2}\PY{p}{,} \PY{l+m+mi}{2}\PY{p}{,} \PY{n}{figsize}\PY{o}{=}\PY{p}{(}\PY{l+m+mi}{12}\PY{p}{,} \PY{l+m+mi}{8}\PY{p}{)}\PY{p}{,} \PY{n}{sharex}\PY{o}{=}\PY{k+kc}{True}\PY{p}{,} \PY{n}{sharey}\PY{o}{=}\PY{k+kc}{True}\PY{p}{)}
\PY{n}{axes} \PY{o}{=} \PY{n}{axes}\PY{o}{.}\PY{n}{flatten}\PY{p}{(}\PY{p}{)}

\PY{k}{for} \PY{n}{i}\PY{p}{,} \PY{n}{t} \PY{o+ow}{in} \PY{n+nb}{enumerate}\PY{p}{(}\PY{n}{checkpoints}\PY{p}{)}\PY{p}{:} \PY{c+c1}{\PYZsh{} Plotting the particle positions at different time checkpoints.}
    \PY{n}{pos} \PY{o}{=} \PY{n}{snapshots}\PY{p}{[}\PY{n}{i}\PY{p}{]}
    \PY{n}{axes}\PY{p}{[}\PY{n}{i}\PY{p}{]}\PY{o}{.}\PY{n}{scatter}\PY{p}{(}\PY{n}{pos}\PY{p}{[}\PY{p}{:}\PY{p}{,} \PY{l+m+mi}{0}\PY{p}{]}\PY{p}{,} \PY{n}{pos}\PY{p}{[}\PY{p}{:}\PY{p}{,} \PY{l+m+mi}{1}\PY{p}{]}\PY{p}{,} \PY{n}{s}\PY{o}{=}\PY{l+m+mi}{1}\PY{p}{,} \PY{n}{alpha}\PY{o}{=}\PY{l+m+mf}{0.5}\PY{p}{)}
    \PY{n}{axes}\PY{p}{[}\PY{n}{i}\PY{p}{]}\PY{o}{.}\PY{n}{set\PYZus{}title}\PY{p}{(}\PY{l+s+sa}{f}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Time: }\PY{l+s+si}{\PYZob{}}\PY{n}{t}\PY{l+s+si}{\PYZcb{}}\PY{l+s+s2}{s}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}
    \PY{n}{axes}\PY{p}{[}\PY{n}{i}\PY{p}{]}\PY{o}{.}\PY{n}{set\PYZus{}xlim}\PY{p}{(}\PY{l+m+mi}{0}\PY{p}{,} \PY{l+m+mi}{25}\PY{p}{)}
...
\PY{k}{for} \PY{n}{i} \PY{o+ow}{in} \PY{n+nb}{range}\PY{p}{(}\PY{n+nb}{len}\PY{p}{(}\PY{n}{snapshots}\PY{p}{)}\PY{p}{)}\PY{p}{:} \PY{c+c1}{\PYZsh{} Compute and plot the concentration field for each snapshot with the source term}
    ...
    \PY{n}{contour} \PY{o}{=} \PY{n}{axes}\PY{p}{[}\PY{n}{i}\PY{p}{]}\PY{o}{.}\PY{n}{contourf}\PY{p}{(}\PY{n}{x\PYZus{}grid}\PY{p}{,} \PY{n}{y\PYZus{}grid}\PY{p}{,} \PY{n}{C}\PY{p}{,} \PY{n}{levels}\PY{o}{=}\PY{l+m+mi}{15}\PY{p}{,} 
                               \PY{n}{cmap}\PY{o}{=}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Reds}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
    \PY{n}{axes}\PY{p}{[}\PY{n}{i}\PY{p}{]}\PY{o}{.}\PY{n}{set\PYZus{}title}\PY{p}{(}\PY{l+s+sa}{f}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Time: }\PY{l+s+si}{\PYZob{}}\PY{n}{checkpoints}\PY{p}{[}\PY{n}{i}\PY{p}{]}\PY{l+s+si}{\PYZcb{}}\PY{l+s+s2}{ s}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}
    \PY{n}{axes}\PY{p}{[}\PY{n}{i}\PY{p}{]}\PY{o}{.}\PY{n}{set\PYZus{}xlim}\PY{p}{(}\PY{l+m+mi}{0}\PY{p}{,} \PY{l+m+mi}{25}\PY{p}{)}
    \PY{n}{axes}\PY{p}{[}\PY{n}{i}\PY{p}{]}\PY{o}{.}\PY{n}{set\PYZus{}ylim}\PY{p}{(}\PY{o}{\PYZhy{}}\PY{l+m+mi}{5}\PY{p}{,} \PY{l+m+mi}{5}\PY{p}{)}  
    \PY{n}{axes}\PY{p}{[}\PY{n}{i}\PY{p}{]}\PY{o}{.}\PY{n}{set\PYZus{}xlabel}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{x [Position]}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}
